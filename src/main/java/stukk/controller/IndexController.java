...
public class IndexController {
    ...
    @GetMapping("/")
    public void index(@ApiIgnore HttpServletResponse response) throws IOException {
        response.sendRedirect("/front/page/showTime.html");
    }

    @ApiOperation(value = "重定向到后台登录页面")
    @GetMapping("/admin")
    public void admin(@ApiIgnore HttpServletResponse response) throws IOException {
